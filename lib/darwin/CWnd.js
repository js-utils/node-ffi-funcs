...
class CWnd {
  ...
  static GetWindowWithWinName(winNameReg, winOwnerNameReg = '') {
    let windowRef = ffihelper.GetWindowWithWinName(winNameReg, winOwnerNameReg)
  ...
  static SetForegroundWindowWithWinName(winNameReg, winOwnerNameReg = '') {
    return ffihelper.SetForegroundWindowWithWinName(winNameReg, winOwnerNameReg)
  }
